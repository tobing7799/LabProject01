...
void CTexture::CreateBuffer(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList, void* pData, UINT nElements, UINT nStride, DXGI_FORMAT ndxgiFormat, D3D12_HEAP_TYPE d3dHeapType, D3D12_RESOURCE_STATES d3dResourceStates, UINT nIndex)
{
	...
	m_ppd3dTextures[nIndex] = ::CreateBufferResource(pd3dDevice, pd3dCommandList, pData, nElements * nStride, d3dHeapType, d3dResourceStates, &m_ppd3dTextureUploadBuffers[nIndex],0);
}
...
void CMaterial::UpdateShaderVariables(ID3D12GraphicsCommandList* pd3dCommandList)
{
	...
	TEXTURE texture{ m_pTexture->m_xmf4x4Texture._11, m_pTexture->m_xmf4x4Texture._22 ,m_pTexture->m_xmf4x4Texture._31, m_pTexture->m_xmf4x4Texture._32 };
 	...
 	pd3dCommandList->SetGraphicsRoot32BitConstants(1, 8, &texture, 16);
	pd3dCommandList->SetGraphicsRoot32BitConstants(1, 1, &m_nType, 24);
...
void CGameObject::UpdateShaderVariable(ID3D12GraphicsCommandList* pd3dCommandList, XMFLOAT4X4* pxmf4x4World)
{
	...
	pd3dCommandList->SetGraphicsRoot32BitConstants(1, 1, &m_nMaterials, 25);
}
...
CHeightMapTerrain::CHeightMapTerrain(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList, ID3D12RootSignature* pd3dGraphicsRootSignature, LPCTSTR pFileName, int nWidth, int nLength, int nBlockWidth, int nBlockLength, XMFLOAT3 xmf3Scale, XMFLOAT4 xmf4Color) : CGameObject(0, 1)
{
	...
	pTerrainTexture->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"Image/noname.dds", RESOURCE_TEXTURE2D, 0);
...
//	SetPosition(0, 0, 0);
	...
	CGameObject::TerrainRender(pd3dCommandList, pCamera);
}
*/
